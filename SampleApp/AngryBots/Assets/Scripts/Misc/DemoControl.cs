...
public class DemoControl : MonoBehaviour
{
	...
	void Start ()
	{
		...
		// Create a banner and add it to the view hierarchy at the top left corner of the screen
		...
		BurstlyAds.setBannerRefreshRate("banner", 20);
		
		// Create an interstitial and precache it
		...
		Debug.Log(BurstlyCurrency.getBalance("coins"));
	}
